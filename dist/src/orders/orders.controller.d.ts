...
export declare class OrdersController {
    ...
    getOrderById(req: any, orderId: string): Promise<{
        id: string;
        totalAmount: number;
        status: import("@prisma/client").$Enums.OrderStatus;
        paymentMethod: string;
    ...
    processPayment(req: any, orderId: string, paymentData: {
        paymentId: string;
        orderId: string;
        signature: string;
    }): Promise<{
...
export declare class SellerOrdersController {
    private ordersService;
    constructor(ordersService: OrdersService);
    getSellerOrders(req: any): Promise<{
        id: string;
        orderNumber: string;
        customer: {
            email: string;
    ...
    getSellerOrderById(req: any, orderId: string): Promise<{
        id: string;
        orderNumber: string;
        customer: {
            email: string;
